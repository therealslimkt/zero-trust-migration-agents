...
VALUES
    ('tnt_TESTTENANT01', 'run_TESTRUN000001',
     'sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb',
     'sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
     clock_timestamp() + interval '1 hour');
UPDATE approval_nonces SET consumed_at = clock_timestamp(), approval_id = 'apr_APPROVAL00001'
WHERE tenant_id = 'tnt_TESTTENANT01' AND run_id = 'run_TESTRUN000001'
...
VALUES
    ('tnt_TESTTENANT01', 'apr_APPROVAL00001', 'run_TESTRUN000001',
     'sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
     'sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb',
     'approved', 'principal:test-owner');
UPDATE runs SET lifecycle_state = 'approved', approval_id = 'apr_APPROVAL00001', revision = 3
WHERE tenant_id = 'tnt_TESTTENANT01' AND run_id = 'run_TESTRUN000001';
...
VALUES
    ('tnt_TESTTENANT01', 'rel_RELEASE000001', 'run_TESTRUN000001', 'apr_APPROVAL00001',
     'sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
     'production',
...
VALUES
    ('tnt_TESTTENANT01', 'run_TESTRUN000001', 2, 'evt_RELEASE000001',
     'release.created', 4, 'approved', 'apr_APPROVAL00001', 'rel_RELEASE000001',
